...
function SalesChart({ bookings, numDays }) {
  ...
  //keeping this for reference in how to use a way with better time complexity O(n) but still using the above way with the complixity of O(n*m) since the size of dates and bookings is relatively small and it wouldn't couse any issues
  ...
  // const data = allDates.map((date) => {
  //   const dateString = date.toDateString();
  //   const bookingsOnDate = bookingsByDate[dateString] || [];
